...
export const skills = [
  {
    icon: "code",
    label: "Languages",
    technologies: ["Python", "PySpark", "Java", "C", "C++", "PowerShell", "Unix", "SQL"],
  },
  {
    icon: "cloud",
  ...
  },
  {
    icon: "database",
    label: "Big Data",
    technologies: ["Hadoop", "Scala", "HDFS", "Pig", "Hive", "Kafka", "Spark"],
  },
  {
    icon: "chart",
    label: "Reporting",
  ...
  },
  {
    icon: "tools",
    label: "Other Tools",
    technologies: ["HTML", "CSS", "JS", "Spring", "Docker", "K8s", "SonarQube", "Eclipse", "Hibernate", "Maven"],
  },
  {
    icon: "smile",
    label: "Soft Skills",
